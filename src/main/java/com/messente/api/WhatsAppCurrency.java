...
public class WhatsAppCurrency {
  ...
  **/
   ...
   * @return the WhatsAppCurrency instance itself
   */
  public WhatsAppCurrency putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fallbackValue, whatsAppCurrency.fallbackValue) &&
        ...
        Objects.equals(this.additionalProperties, whatsAppCurrency.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fallbackValue, code, amount1000, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WhatsAppCurrency>() {
           ...
           public WhatsAppCurrency read(JsonReader in) throws IOException {
             ...
             WhatsAppCurrency instance = thisAdapter.fromJsonTree(jsonObj);
