...
public class ErrorOmnichannel {
   ...
   * @return the ErrorOmnichannel instance itself
   */
  public ErrorOmnichannel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, errorOmnichannel.errors)&&
        Objects.equals(this.additionalProperties, errorOmnichannel.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayerrors.size(); i++) {
        ErrorItemOmnichannel.validateJsonElement(jsonArrayerrors.get(i));
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorOmnichannel>() {
           ...
           public ErrorOmnichannel read(JsonReader in) throws IOException {
             ...
             ErrorOmnichannel instance = thisAdapter.fromJsonTree(jsonObj);
