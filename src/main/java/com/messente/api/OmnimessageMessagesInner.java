...
import com.messente.api.ViberCarousel;
...
public class OmnimessageMessagesInner extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Rcs> adapterRcs = gson.getDelegateAdapter(this, TypeToken.get(Rcs.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<OmnimessageMessagesInner>() {
                ...
                public void write(JsonWriter out, OmnimessageMessagesInner value) throws IOException {
                    ...
                    // check if the actual instance is of the type `Rcs`
                    if (value.getActualInstance() instanceof Rcs) {
                        JsonElement element = adapterRcs.toJsonTree((Rcs)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: Rcs, SMS, Viber, WhatsApp");
                }
                ...
                public OmnimessageMessagesInner read(JsonReader in) throws IOException {
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        Rcs.validateJsonElement(jsonElement);
                        actualAdapter = adapterRcs;
                        OmnimessageMessagesInner ret = new OmnimessageMessagesInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for Rcs failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'Rcs'", e);
                    }

                    throw new IOException(String.format("Failed deserialization for OmnimessageMessagesInner: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof Rcs) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Rcs, SMS, Viber, WhatsApp");
    }
     ...
     * Rcs, SMS, Viber, WhatsApp
     *
     * @return The actual instance (Rcs, SMS, Viber, WhatsApp)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Rcs`
     * @throws ClassCastException if the instance is not `Rcs`
     */
    public Rcs getRcs() throws ClassCastException {
        return (Rcs)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with Rcs
        try {
            Rcs.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        throw new IOException(String.format("The JSON string is invalid for OmnimessageMessagesInner with anyOf schemas: Rcs, SMS, Viber, WhatsApp. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
