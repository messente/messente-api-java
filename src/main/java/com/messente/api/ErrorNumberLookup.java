...
public class ErrorNumberLookup {
   ...
   * @return the ErrorNumberLookup instance itself
   */
  public ErrorNumberLookup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, errorNumberLookup.errors)&&
        Objects.equals(this.additionalProperties, errorNumberLookup.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayerrors.size(); i++) {
        ErrorItemNumberLookup.validateJsonElement(jsonArrayerrors.get(i));
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorNumberLookup>() {
           ...
           public ErrorNumberLookup read(JsonReader in) throws IOException {
             ...
             ErrorNumberLookup instance = thisAdapter.fromJsonTree(jsonObj);
