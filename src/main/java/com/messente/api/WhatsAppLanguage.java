...
public class WhatsAppLanguage {
   ...
   * @return the WhatsAppLanguage instance itself
   */
  public WhatsAppLanguage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, whatsAppLanguage.code) &&
        ...
        Objects.equals(this.additionalProperties, whatsAppLanguage.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WhatsAppLanguage>() {
           ...
           public WhatsAppLanguage read(JsonReader in) throws IOException {
             ...
             WhatsAppLanguage instance = thisAdapter.fromJsonTree(jsonObj);
