...
public class ContactEnvelope {
  ...
  **/
   ...
   * @return the ContactEnvelope instance itself
   */
  public ContactEnvelope putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contact, contactEnvelope.contact)&&
        Objects.equals(this.additionalProperties, contactEnvelope.additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("contact") != null && !jsonObj.get("contact").isJsonNull()) {
        ContactResponseFields.validateJsonElement(jsonObj.get("contact"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContactEnvelope>() {
           ...
           public ContactEnvelope read(JsonReader in) throws IOException {
             ...
             ContactEnvelope instance = thisAdapter.fromJsonTree(jsonObj);
