...
public class GroupName {
   ...
   * @return the GroupName instance itself
   */
  public GroupName putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, groupName.name)&&
        Objects.equals(this.additionalProperties, groupName.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupName>() {
           ...
           public GroupName read(JsonReader in) throws IOException {
             ...
             GroupName instance = thisAdapter.fromJsonTree(jsonObj);
