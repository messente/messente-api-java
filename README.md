...
```groovy
dependencies {
    implementation 'com.messente.api:messente-api:4.7.0'
}
```
...
```xml
<dependency org='com.messente.api' name='messente-api' rev='4.7.0'/>
```
